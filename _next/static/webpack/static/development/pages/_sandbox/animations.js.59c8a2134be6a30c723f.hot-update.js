...
/***/ "./imports/packages/animations/interpolations.jsx":
/*!********************************************************!*\
  !*** ./imports/packages/animations/interpolations.jsx ***!
  \********************************************************/
/*! exports provided: changeSpeed */
...
var changeSpeed = function changeSpeed(st) {
  var speed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20000;
  var move = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 600;
  return "translateY(".concat(-(st * speed) + move, "px)");
};
...
/* harmony import */ var _imports_packages_animations_interpolations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../imports/packages/animations/interpolations */ "./imports/packages/animations/interpolations.jsx");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_imports_wrap_page__WEBPACK_IMPORTED_MODULE_5__["wrapPage"])(function () {
  ...
  var item2 = Object(react_spring__WEBPACK_IMPORTED_MODULE_4__["interpolate"])([st, xys], function (st, xys) {
    return "rotate(".concat(st * 1000, "deg)");
  });
  var item3 = Object(react_spring__WEBPACK_IMPORTED_MODULE_4__["interpolate"])([st, xys], function (st, xys) {
    return Object(_imports_packages_animations_interpolations__WEBPACK_IMPORTED_MODULE_6__["changeSpeed"])(st, 20000, 600);
  });
  var item4 = Object(react_spring__WEBPACK_IMPORTED_MODULE_4__["interpolate"])([st, xys], function (st, xys) {
    return Object(_imports_packages_animations_interpolations__WEBPACK_IMPORTED_MODULE_6__["changeSpeed"])(st, 50000, 0);
  });
...
//# sourceMappingURL=animations.js.59c8a2134be6a30c723f.hot-update.js.map